        ...
        <View style={styles.overlay}>
          <View key={modalKey} style={styles.modalBox}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              {language === "ar" && (
                <>
                  <Text style={[styles.title, styles.rtl]}>اتفاقية الشروط والأحكام لتطبيق اسأل راشد</Text>

                  <Text style={[styles.heading, styles.rtl]}>1. قبول الشروط والأحكام</Text>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>2. وصف الخدمة</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>3. إخلاء المسؤولية: طبيعة الخدمات</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>4. أهلية المستخدم</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>5. تسجيل الحساب والأمان</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>6. شروط الدفع</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>7. سياسة الاسترداد</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>8. سياسة إعادة الجدولة</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>9. سلوك المستخدم والمسؤوليات</Text>
                  <Text style={[styles.text, styles.rtl]}>
                    أنت توافق على:
                  ...
                  <Text style={[styles.heading, styles.rtl]}>10. حقوق الملكية الفكرية</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>11. حدود المسؤولية</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>12. إخلاء مسؤولية الضمانات</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>13. إنهاء الحساب</Text>
                  <Text style={[styles.text, styles.rtl]}>
                    نحتفظ بالحق في تعليق أو إنهاء حسابك وفقاً لتقديرنا الخاص لانتهاك هذه الشروط، أو السلوك المسيء، أو أي سبب معقول آخر.
                  </Text>

                  <Text style={[styles.heading, styles.rtl]}>14. تعديلات الشروط</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>15. القانون الحاكم</Text>
                  <Text style={[styles.text, styles.rtl]}>
                    تخضع هذه الشروط وتحكم وفقاً للقوانين المعمول بها. يجب معالجة أي نزاعات أولاً من خلال التفاوض بحسن نية.
                  </Text>

                  <Text style={[styles.heading, styles.rtl]}>16. معلومات الاتصال</Text>
                  <Text style={[styles.text, styles.rtl]}>
                  ...
                  <Text style={[styles.heading, styles.rtl]}>الإقرار النهائي</Text>
                  <Text style={[styles.text, styles.rtl]}>
              ...
              {language === "en" && (
                <>
                  <Text style={styles.title}>TERMS AND CONDITIONS AGREEMENT FOR ASK RASHID</Text>
                  ...
                  <Text style={styles.heading}>3. Disclaimer: Nature of Services</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>4. User Eligibility</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>5. Account Registration and Security</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>8. Rescheduling Policy</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>9. User Conduct and Responsibilities</Text>
                  <Text style={styles.text}>
                    You agree to:
                  ...
                  <Text style={styles.heading}>10. Intellectual Property Rights</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>13. Account Termination</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>14. Modifications to Terms</Text>
                  <Text style={styles.text}>
                  ...
                  <Text style={styles.heading}>FINAL ACKNOWLEDGMENT</Text>
                  <Text style={styles.text}>
            ...
            <View style={styles.buttons}>
              <TouchableOpacity style={[styles.button, styles.acceptBtn]} onPress={acceptTerms}>
                <Text style={styles.btnText}>{language === "en" ? "ACCEPT TERMS" : "قبول الشروط"}</Text>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.button, styles.cancelBtn]} onPress={cancelTerms}>
                <Text style={styles.btnText}>{language === "en" ? "DECLINE TERMS" : "رفض الشروط"}</Text>
              </TouchableOpacity>
            </View>
